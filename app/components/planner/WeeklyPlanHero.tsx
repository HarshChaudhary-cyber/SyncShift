          ...
          {contextSummary && (
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-[var(--bg-card)] border border-[var(--border-color)] text-xs">
                <span className="text-indigo-400 font-bold">🏛️ {contextSummary.enrolled_classes_count}</span>
                <span className="text-[var(--text-secondary)]">Class Meetings</span>
              </div>
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-[var(--bg-card)] border border-[var(--border-color)] text-xs">
                <span className="text-amber-400 font-bold">💼 {contextSummary.fixed_work_shifts_count}</span>
                <span className="text-[var(--text-secondary)]">Work Shifts</span>
              </div>
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-[var(--bg-card)] border border-[var(--border-color)] text-xs">
                <span className="text-purple-400 font-bold">🎯 {contextSummary.pending_tasks_count}</span>
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            {hasAppliedPlan && onRevertClick && (
              <button
                ...
                className="px-3.5 py-2 rounded-xl bg-red-950/20 hover:bg-red-950/40 border border-red-800/40 text-xs text-red-400 font-medium transition cursor-pointer"
